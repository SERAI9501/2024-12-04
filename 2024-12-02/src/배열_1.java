 ...
 *              =>같은 데이터형만 모아서 관리
 *    2) 단점 => 가변형 데이터 (모아서 컬렉션이라부른다.)
 *       => 한번 선언하면 추가/삭제가 어렵다.(변경이 어렵다)
 *                    ------> 새롭게 큰 배열을 생성
 *                    ------> 작은 배열을 생성
 ...
 *                                       ---- 0부터 시작 => 갯수보다 한개가 작다(배열명.length-1) 
 *                                    =>배열명[0]
 *                                    =>배열명[1]
 *                                    --------- 일반 변수와 동일하게 사용
 *                                    값 읽기 => 배열명[0]
 ...
 *                                      |한개의 이름으로 통일
 *                            => 데이터 묶기
 *                              => 연속적인 메모리 구조 => 데이터 크기 동이래야 된다.
 *                              => 한번 선언하면 변경이 어렵다
 *                               --------------------- 고정적 메모리 구조
 *                                | 보완 => 브이브러리 지원 (Collection)
 *                                                    ------------ 10장 => 웹에서 주로 사용
 *                                                    
 *                                      
 */
 ...
 *   long[] arr={1,2,3,4,5}
 *              ----------- long 으로 변경
 *  => 86page => 96page 까지만 공부
 */
public class 배열_1 {
// 멤버변수 => 다른 클래스에서도 사용이 가능하다 => heap에 저장
// 프로그램 종료시까지 사용이 가능
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// 지역변수 =>  main에서만 사용이 가능 / stack에 저장
		// main이 조욜가 되면 자동으로 사라진다 
		//정수 / 문자 / 문자열
		//1.정수 => 10개 => 평균
		//초기값 결정 => 0으로 디폴트
		int[] arr=new int[10];

...
public class 컬렉션_3_ArrayList {
	...
	public static void main(String[] args) {
		...
		//배정된 배열을 자동으로 추가시마다 자동으로 메모리가 늘어난다.
		// 데이터 추가
		...
		for(Object std:list)
		{
			...
			String ss=String.format("%.2f", (s.getKor()+s.getEng()+s.getMath())/3.0); // 변환하는 방법
			
			System.out.println(s.getHakbun()+" "+s.getName()+" "+s.getKor()+" "+s.getEng()+" "+s.getMath()+" "+ss);

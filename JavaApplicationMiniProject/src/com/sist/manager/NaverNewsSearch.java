...
/*
 * {	"lastBuildDate":"Tue, 21 Jan 2025 12:31:23 +0900",	"total":675726,	"start":1,	"display":10,	
 * "items":[		
...
public class NaverNewsSearch {
    ...
    {
    	List<NewsVO> list=new ArrayList<NwesVO>()
    	        String clientId = "8OAkb3yEnnxbhHQzALJX"; //애플리케이션 클라이언트 아이디
    	        String clientSecret = "OJyCiKL0xa"; //애플리케이션 클라이언트 시크릿
    	        ...
    	        //{키:값, 키:값...} => 자바 => 자바스크립트로 전송 Ajax / Vue / React
    	        ...
    	        try
    	        {
    	        	...
    	        	JSONObject root=(JSONObject)jp.arse(responsBody);
    	        	JSONAraay items=(JSONArray)root.get("items");
    	        	for(int i=0;i<items.size();i++)
    	        	{
    	        		NwesVO vo=new NewsVO();

...
public class 라이브러리_7 {
	...
	public static void main(String[] args) {
		...
		Calendar today=Calendar.getInstance();//오늘 날짜 가져온다. = 읽는다
		System.out.println("년도:"+today.get(Calendar.YEAR));
		System.out.println("월:"+(today.get(Calendar.MONTH)+1));
		// Month 가 1부터가 아니라 1부터 시작하기에
		// 저장할때는 -1 가져올때는 +1을 붙여야 한다
		...
		System.out.println((today.get(Calendar.MONTH)+1)+"월의 마지막 날"+today.getActualMaximum(0));
